...
async function fetchProjects() {
  if (!TOKEN || !USERNAME) {
    console.error('Error: Missing VITE_GITHUB_USERNAME or VITE_GITHUB_TOKEN in .env.local or environment');
    console.log('Please configure your GitHub username and token.');
    return;
  }
